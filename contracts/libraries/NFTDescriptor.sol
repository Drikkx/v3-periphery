...
// import '@flagswap/v3-core/contracts/libraries/BitMath.sol';
...
//         // Convertit l'adresse en uint256
//         uint256 addrUint = uint256(uint160(addr));
//         // Convertit le uint256 en chaîne hexadécimale
//         string memory addrStr = Strings.toHexString(addrUint);
//         return addrStr;
//     }
